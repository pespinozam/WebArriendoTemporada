        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="home.php"><i class="fa fa-dashboard"></i> Estado Reservas</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> Pago Factura</a>
                    </li>
                    <li>
                        <a href="profit.php"><i class="fa fa-qrcode"></i> Detalle</a>
                    </li>
                ...
                <div class="row">
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        ...
                                        <select name="conf" class="form-control">
                                            ...
                                            <option value="Conform">Confirmar la Reserva</option>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-heading"
                                style="background-color:#33d6fb;text-align: center;font-family: Georgia, 'Times New Roman', Times, serif;">
