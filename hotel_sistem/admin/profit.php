...
<head>
    ...
    <title> HOTEL TAIPE & CHONTA</title>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="home.php"><i class="fa fa-dashboard"></i> Estado Habitacion</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="active-menu" href="profit.php"><i class="fa fa-qrcode"></i> Detalle</a>
                    </li>
