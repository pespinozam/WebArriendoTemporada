        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="Payment.php"><i class="fa fa-qrcode"></i> Factura Pago</a>
                    </li>
                    <li>
                        <a href="profit.php"><i class="fa fa-qrcode"></i> Detalles</a>
                    </li>
                    <li>
						...
						?>
                            ...
                            <div class="panel-body">
                                <button class="btn btn-primary btn" data-toggle="modal" data-target="#myModal">
                                    Enviar Nuevas Noticias de Promociones
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Redactar Boletín - Mensaje
                                                </h4>
                                            </div>
                                            <form method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="news" class="form-control" rows="5" id="comment"
                                                            placeholder="Ingrese la Noticia"></textarea>
                                                    </div>
                                                </div>
